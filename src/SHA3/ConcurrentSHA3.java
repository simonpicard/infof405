/**
 * sha3sum â€“ SHA-3 (Keccak) checksum calculator
 * 
 * Copyright Â© 2013, 2014  Mattias AndrÃ©e (maandree@member.fsf.org)
 * 
 ...
 * 
 * @author  Mattias AndrÃ©e  <a href="mailto:maandree@member.fsf.org">maandree@member.fsf.org</a>
 */
...
public class ConcurrentSHA3
{
    ...
    /**
     * â„“, the binary logarithm of the word size
     */
    private int l = 0;
	...
	long da, db, dc, dd, de;
        ...
        if (this.w == 64)
	{
            /* Ï� and Ï€ steps, with last two part of Î¸ */
